...
import CaseMainTenance from "./hooksClass";
// table model
...
const caseMaintenance = new CaseMainTenance();
const rules = caseMaintenance.rules;
const {
  table,
  queryRef,
  displayTag,
