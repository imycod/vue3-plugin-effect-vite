<template>
  <div class="form-table" ref="scFormTable">
    ...
    >
      <el-table-column type="index" width="50" fixed="left" v-if="!hideIndex">
        <template #header>
          <el-button
            v-if="!hideAdd"
            type="primary"
        ...
        <template #default="scope">
          <div
            :class="['form-table-handle', { 'form-table-handle-delete': !hideDelete }]"
          >
      ...
      <el-table-column
        ...
        :filter-method="
          (item.filters && (item.filterMethod || filterMethod)) || undefined
        "
      >
        <!-- 自定义表头 -->
